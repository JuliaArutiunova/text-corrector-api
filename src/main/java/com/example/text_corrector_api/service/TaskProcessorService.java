...
public class TaskProcessorService {
    ...
    private final TextCorrectionClient spellerClient;

    public TaskProcessorService(TaskService taskService, TextCorrectionClient spellerClient) {
    ...
    public void processSingleTask(TaskProcessingContext task) {
        ...
        try {
            ...
            log.info("Task with id processed successfully");
        } catch (Exception e) {
